          ...
          <View style={styles.Background} >
            <View style={{ alignItems: 'center', width: '100%', flex: 1 }}>
              ...
              <View style={{ flexDirection: 'row', justifyContent: "space-between", width: '90%', alignItems: 'center' }}>
                ...
                <Text style={{ fontSize: 20, fontWeight: 'bold', color: 'white', marginTop: 10 }}>Binaural Beats</Text>
              ...
              <Text style={styles.destxt} >The pure  notes of the crystals can create binaural beats technology that take you to the theta or delta  brain state to help get to a relaxing state faster.</Text>
              <Image source={require("../../Images/sliderImage3.png")} resizeMode="stretch" style={styles.sliderImage} />
