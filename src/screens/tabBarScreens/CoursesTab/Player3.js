                    ...
                    <LinearGradient colors={['#000000', '#0e0314', '#230633']} style={styles.linearGradient}>
                        <View style={{ height: '100%', width: '100%', justifyContent: 'center' }} >
                            ...
                            <View style={{ justifyContent: 'center', alignItems: 'center', width: '100%', marginTop: 100 }}>
                                ...
                                <LinearGradient colors={['#40175A', '#834D93']} style={styles.linearGradient1}>
                                    <View style={{ borderRadius: 10 }}>
                                        <View style={{ flexDirection: 'row', marginLeft: 12 }}>
                                            <TouchableOpacity style={styles.ExploreBtn} onPress={() => this.props.navigation.navigate("Player2")}>
                                                <Image source={require('../../../Images/SelectImage..png')} resizeMode="stretch" style={{ width: 20, height: 20, borderRadius: 10 }} />
                                            </TouchableOpacity>
                                            <Text style={{ color: 'white' }}>Sound guided meditation</Text>
                                        </View>
                                        <View style={{ flexDirection: 'row', marginLeft: 12, marginTop: 15 }}>
                                            <TouchableOpacity style={styles.ExploreBtn} onPress={() => this.props.navigation.navigate("Player2")}>
                                                <Image source={require('../../../Images/UnselectImage..png')} resizeMode="stretch" style={{ width: 20, height: 20, borderRadius: 10 }} />
                                            </TouchableOpacity>
                                            <Text style={{ color: 'white' }}>Singing bowls only</Text>
                                        </View>
                                    </View>
                                </LinearGradient>
