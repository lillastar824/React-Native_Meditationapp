      ...
      <SafeAreaView style={styles.container}>
        <LinearGradient colors={['#000000', '#0e0314', '#230633']} style={styles.linearGradient}>
          <View style={{height:'100%', width:'100%', alignItems:'center'}}>
            <View style={{ width: 273, height: 331, marginTop: 120, alignItems: 'center', borderTopLeftRadius: 10, borderTopRightRadius: 10, backgroundColor: '#1F062C' }}>
              ...
              <Image style={{ width: 182, height: 182, borderRadius: 91, marginTop: 20 }} source={require('../../../Images/RateImage.png')} />
              <Text style={{ fontSize: 20, color: '#fff', fontWeight: 'bold', textAlign: 'center', marginTop: 30 }}>Rate Inner Wonders?</Text>
              <Text style={{ fontSize: 13, color: '#fff', marginTop: 20 }}>Show us how much you love our app!</Text>
            </View>
            <TouchableHighlight onPress={() => this.props.navigation.goBack()} style={{ borderBottomLeftRadius: 10, borderBottomRightRadius: 10, backgroundColor: '#561E98', width: 273 }}>
              <Text style={{ fontSize: 20, color: '#fff', marginTop: 10, textAlign: 'center', height: 40 }}>Rate now</Text>
            </TouchableHighlight>
          </View>
