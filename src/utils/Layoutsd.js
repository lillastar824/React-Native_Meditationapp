...
const Layouts = {
  ...
  //Dashboard-Pad
  DASHBOARD_LIST_ITEM_HEIGHT: height * 0.113,
  ...
  MARGIN_NORMAL_VERTICAL: width * 0.01,
  ...
  normal_font_SIZE_SMALL: height * 0.06 * 0.4,
  ...
  //input text
  INPUTTEXT_HEIGHT_NORMAL: height * 0.08,
